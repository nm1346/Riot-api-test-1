...
//            }
            ...
            if(i <= 4){
               ...
               spell_list1.add(riotApiManager.apiSummonerSpell(spell));
               spell_list2.add(riotApiManager.apiSummonerSpell(spel2));
               ...
               spell_list3.add(riotApiManager.apiSummonerSpell(spell));
               spell_list4.add(riotApiManager.apiSummonerSpell(spel2));
